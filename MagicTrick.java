...
public class MagicTrick {
    ...
    static final int ACEVALUE = 1;
    static final int TENVALUE = 10;
    static final int JACKVALUE = 11;
    static final int QUEENVALUE = 12;
    static final int KINGVALUE = 13;
    static final String[] cards = {"AC","2C","3C","4C","5C","6C","7C","8C","9C","TC","JC","QC","KC",
                                    "AD","2D","3D","4D","5D","6D","7D","8D","9D","TD","JD","QD","KD",
                                    "AH","2H","3H","4H","5H","6H","7H","8H","9H","TH","JH","QH","KH",
                                    "AS","2S","3S","4S","5S","6S","7S","8S","9S","TS","JS","QS","KS"};
    static final int NUMBEROFPARTITIONS = 6;
    static final int TURNEDPARTITIONS = 3;
    static final int TURNEDFROMTURNED = 2;
    public static void main(String[] args) {
        ...
        System.out.println("Remaining turned partitions: " + remainingPartitions);
        ...
        System.out.println("Cards left in the deck: " + mergedDeckSize);
